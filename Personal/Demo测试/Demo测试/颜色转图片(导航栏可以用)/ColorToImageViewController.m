...
- (void)viewDidLoad {
    ...
    self.SourceArray = [NSMutableArray arrayWithObjects:@[@"ColorToImageViewController.h", @"DemoSourceViewController"], @[@"ColorToImageViewController.m", @"DemoSourceViewController"], @[@"UIColor+ColorToImage.h", @"DemoSourceViewController"], @[@"UIColor+ColorToImage.m", @"DemoSourceViewController"], nil];
}
