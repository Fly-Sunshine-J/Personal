...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        loadingLabel.text = @"右\n拉\n刷\n新\n.\n.\n.\n";
        loadingLabel.numberOfLines = [loadingLabel.text length];
        ...
        [loadingLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(0);
            make.bottom.mas_equalTo(0);
            make.top.mas_equalTo(indicatorView.mas_bottom);
        }];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.x <= -REFRSHCONTROL_WIDTH) {
        [indicatorView startAnimating];
        if (![loadingLabel.text isEqualToString:@"正\n在\n刷\n新\n.\n.\n.\n"]) {
            loadingLabel.text = @"松\n手\n刷\n新\n.\n.\n.\n";
        }
    }
