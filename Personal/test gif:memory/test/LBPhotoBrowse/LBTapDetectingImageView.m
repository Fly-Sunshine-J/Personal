...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    [LBPhotoBrowseManager defaultManager].currentCollectionView.superview.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:(LB_DISMISS_DISTENCE-currentDeviationFromBegin)/(LB_DISMISS_DISTENCE - 40)];
}
