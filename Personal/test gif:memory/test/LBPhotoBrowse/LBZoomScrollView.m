...
- (void)handlesingleTap:(CGPoint)touchPoint {
    ...
    if (touchPoint.x == -1 && touchPoint.y == -1) {
        if ([LBPhotoBrowseManager defaultManager].style == LBMaximalImageViewOnDragDismmissStyleOne) {
...
- (void)lb_touchMoveStyleOne:(UIPanGestureRecognizer *)pan  {
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        ...
        [LBPhotoBrowseManager defaultManager].currentCollectionView.superview.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:ratio];
        ...
        [UIView animateWithDuration:0.35 animations:^{
            [LBPhotoBrowseManager defaultManager].currentCollectionView.superview.backgroundColor = [UIColor blackColor];
...
- (void)lb_touchMoveStyleTwo:(UIPanGestureRecognizer *)pan  {
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        ...
        // 保证背景View的颜色变化 --> 150
        if (deviationY > 150) {
            [LBPhotoBrowseManager defaultManager].currentCollectionView.superview.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:(LB_DISMISS_DISTENCE-deviationY)/(LB_DISMISS_DISTENCE - 30)];
        }else {
            [LBPhotoBrowseManager defaultManager].currentCollectionView.superview.backgroundColor = [UIColor blackColor];
        }
