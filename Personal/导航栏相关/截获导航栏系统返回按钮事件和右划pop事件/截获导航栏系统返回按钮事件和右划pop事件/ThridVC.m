...
@interface ThridVC ()<YYNavigationControllerShouldPopDelegate>
...
- (BOOL)navigationControllerShouldPop:(UINavigationController *)navigationController {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(gobackWithColor:)]) {
        [self.delegate gobackWithColor:[UIColor purpleColor]];
    }
